...
function Hero() {
  ...
  return (
    ...
    <div className="text-white lg:mt-20 xl:ms-20">
    ...
    <p className='xl:text-4xl md:text-4xl text-1xl text-teal-200 pb-3'> I am Emmanuel Akinola. </p>
     <TypeAnimation sequence={[
      ...
      style={{ fontSize: '.9em', display: 'inline-block', color: 'white', fontFamily: 'Open Sans, cursive' }}   />
       <div className="flex">
         <a href="#About"> <button className='bg-black border-2 border-teal-500 text-teal-200 p-3 rounded-lg text-xs md:text-sm my-6 hover:bg-teal-500 hover:border-black hover:text-white hover:transition hover:ease-in hover:duration-300'> More About Me </button> </a>
         <a href="https://docs.google.com/document/d/1w1SPwx3xgAi11RGN7zpJBJRHOw46yJQ21TlY52EJhp8/edit?usp=sharing" target="blank"><button className=' bg-black border-2 border-teal-500 text-teal-200 p-3 rounded-lg text-xs md:text-sm my-6 mx-2 hover:bg-teal-500 hover:border-black hover:text-white hover:transition hover:ease-in hover:duration-300'> My Resume  </button> </a> 
        </div>
        
     </div>


     <div className="md:order-first md:m-10 lg:mt-20">
